...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      router.push("/wellness"); // redirect after login
    }
  };
          ...
          <div className="p-8">
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <Mail className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-teal-800" />
                  <input
                    type="email"
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-12 pr-12 py-4 border-2 border-teal-200/50 rounded-2xl focus:border-teal-400 focus:outline-none font-light text-teal-800 placeholder-teal-400 bg-white/70 backdrop-blur-sm transition-all duration-300"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 text-teal-400 hover:text-teal-600 transition-colors duration-300"
                  >
                    {showPassword ? (
              ...
              <div className="text-right">
                <button
                  type="button"
                  className="text-sm text-teal-600 hover:text-teal-700 font-light transition-colors duration-300"
                >
